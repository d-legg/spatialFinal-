...
class Ui_GetCensusDialogBase(object):
    def setupUi(self, GetCensusDialogBase):
        ...
        self.button_box.setGeometry(QtCore.QRect(170, 370, 341, 32))
        ...
        self.addGeo.setGeometry(QtCore.QRect(10, 300, 121, 32))
        self.addGeo.setObjectName("addGeo")
        self.plotButton = QtWidgets.QPushButton(GetCensusDialogBase)
        self.plotButton.setGeometry(QtCore.QRect(130, 330, 113, 32))
        ...
        self.addData.setGeometry(QtCore.QRect(10, 330, 121, 32))
    ...
    def addCensusVector(self):
        ...
        if self.geographyName == 'State':
            ...
            layer = QgsVectorLayer(temp_shapefile, 'Census Data'+str(self.addDataIndex), 'ogr')
        ...
        if self.geographyName == 'Congressional District':
            ...
            print(fileS)
            stateDF = fileS[fileS['STATEFP'] == stateFIP]
            print('countyDF', stateDF)
            
            if(self.cdBox.currentText() == ''):
                countyDF = stateDF
            else:
                countyDF = stateDF[stateDF['CD116FP'] == self.congName]
    ...
    def addShapeFile(self):
        ...
        if self.geographyName == 'State' or self.geographyName == 'County':
            print('state geo!')
            # Define the path to the shapefile
            shapefilePath = os.path.join(self.pluginPath, 'data', 'tl_2021_us_' + str(self.geographyName.lower()), 'tl_2021_us_'+ str(self.geographyName.lower()) +'.shp')
            ...
            layer = QgsVectorLayer(shapefilePath, self.geographyName, "ogr")
        ...
        if self.geographyName == 'Zipcode':
            ...
            # Load the shapefile as a vector layer
            layer = QgsVectorLayer(shapefilePath, "Zipcodes", "ogr")
        ...
        if self.geographyName == 'Congressional District':
            ...
            # Load the shapefile as a vector layer
            layer = QgsVectorLayer(shapefilePath, "116th Congressional District", "ogr")
